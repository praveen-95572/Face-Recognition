#pip install --force-reinstall opencv-contrib-python==4.5.2.54

import cv2 as cv
import numpy as np
from os import listdir                  #used to fetch directory data
...
model = cv.face.LBPHFaceRecognizer_create()            #Linear binary face histogram face recognizer
...
def face_detector(img , size = 0.5):
     ...
     for(x,y,w,h) in faces:
          cv.rectangle(img, (x,y) ,(x+w ,y+w) , (0,255,255) , 2 )
          roi = img[y:y+h , x:x+w]
...
while True:
     ...
     try:
          ...
          if confidence > 75:
               cv.putText(image , "Unlocked" , (250,450) , cv.FONT_HERSHEY_COMPLEX,1,(250,120,255),2)
